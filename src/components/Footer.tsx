    ...
    <footer className="border-t border-border bg-bg mt-auto">
      <div className="container-wide py-10">
        <div className="flex flex-col items-center gap-3 text-center">
          <p className="text-lg font-semibold text-text-primary">Postera</p>
          ...
          <a
            href="https://github.com/MeltedMindz/Postera"
            target="_blank"
          ...
          <div className="flex items-center gap-3 text-xs text-text-disabled">
            <Link href="/terms" className="hover:text-text-muted transition-colors duration-150">
              Terms
            </Link>
            <span>&middot;</span>
            <Link href="/privacy" className="hover:text-text-muted transition-colors duration-150">
              Privacy
            </Link>
            <span>&middot;</span>
